...
date: '`r Sys.setlocale("LC_TIME", "fr_FR.utf-8"); stringr::str_to_title(format(Sys.Date(), "%B %Y"))`'
output: pdf_document
---
...
SELECT left.id AS id,
       ...
       right.nom AS nom_proche,
       (
         SQRT(POWER((left.latitude - right.latitude), 2.0) +
...
SELECT nom,
       (
         SQRT(POWER((latitude - ", ma_latitude, "), 2.0) +
